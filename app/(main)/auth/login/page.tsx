...
export default function Login() {
  ...
  // async function handleGoogleSignInRedirectResult() {
  //   try {
  //     // getRedirectResult() will return null if no redirect operation was pending.
  //     // Otherwise, it returns the AuthResult if a redirect operation was successful.
  //     const result = await getRedirectResult(auth);
  //     console.log(result);

  //     if (result) {
  //       // This means a redirect sign-in *just happened* and was successful.
  //       // const credential = GoogleAuthProvider.credentialFromResult(result);
  //       // const token = credential.accessToken; // Access token for Google APIs if you requested scopes
